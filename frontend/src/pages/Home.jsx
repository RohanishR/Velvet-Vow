...
import GeometricSplitText from '../components/GeometricSplitText';
    ...
    <>
      ...
      <section className="hero container">
        <ScrollReveal variant="fade-up" duration={0.8}>
          <GeometricSplitText
            text="The Velvet Vow"
            subText="Plan Weddings, Parties & Corporate Events Effortlessly"
            splitDistance={28}
            style={{ marginBottom: 'var(--space-64)' }}
          />
        </ScrollReveal>

        <ScrollReveal variant="zoom" delay={0.25}>
        ...
        <ScrollReveal variant="fade-up" delay={0.4} distance={40}>
      ...
      <section id="services" className="two-column container">
        <ScrollReveal variant="fade-left" distance={80}>
        ...
        <ScrollReveal variant="fade-right" distance={80} delay={0.15}>
